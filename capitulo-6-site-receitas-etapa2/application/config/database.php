...
$db['testes']['username'] = 'codeigniter';
$db['testes']['password'] = 'receitas123';
...
$db['producao']['hostname'] = 'mysql.nomedoservidor.com.br';
$db['producao']['username'] = 'recipes_2012';
$db['producao']['password'] = 'superSenha~9143^';
$db['producao']['database'] = 'receitas_culinarias';
